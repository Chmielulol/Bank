	...
	<form:form action="searchClient" modelAttribute="client" method="Post">
		<table>
			<tr>
				...
				<td><input type="button" value="Home" onclick="window.location.href='home'; return false;" class="add-button"/></td>
			</tr>
			<tr>
				<th>Login</th>
				<th>Type</th>
			...
			<c:forEach var ="tempClient" items="${searchedClients}" varStatus="loop">
